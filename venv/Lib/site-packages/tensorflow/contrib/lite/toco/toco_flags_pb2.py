...
_TOCOFLAGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='allow_flex_ops', full_name='toco.TocoFlags.allow_flex_ops', index=21,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='force_flex_ops', full_name='toco.TocoFlags.force_flex_ops', index=22,
